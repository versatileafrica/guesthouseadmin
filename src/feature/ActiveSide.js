...
export const {setActiveMenu, setProductPan, recupPan, updateQuantity, deleteProduct, relance, setHistorique, recupHistorique, viderPanier, viderHistorique, updateHistoriqueStatus} = sidebarSlice.actions;
